...
/* 
DomainApiService Get top-level domain name from URL
...
*/
func (a *DomainApiService) DomainGetTopLevelDomainFromUrl(ctx context.Context, request ValidateUrlRequestSyntaxOnly) (ValidateUrlResponseSyntaxOnly, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/validate/domain/url/get-top-level-domain"
...
*/
func (a *DomainApiService) DomainIsAdminPath(ctx context.Context, value string) (IsAdminPathResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue IsAdminPathResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/validate/domain/url/is-admin-path"
...
/* 
DomainApiService Check a URL for Phishing threats
...
*/
func (a *DomainApiService) DomainPhishingCheck(ctx context.Context, request PhishingCheckRequest) (PhishingCheckResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue PhishingCheckResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/validate/domain/url/phishing-threat-check"
...
/* 
DomainApiService Check a URL for safety threats
...
*/
func (a *DomainApiService) DomainSafetyCheck(ctx context.Context, request UrlSafetyCheckRequestFull) (UrlSafetyCheckResponseFull, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue UrlSafetyCheckResponseFull
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/validate/domain/url/safety-threat-check"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v UrlSafetyCheckResponseFull
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/* 
DomainApiService Check a URL for SSRF threats
...
*/
func (a *DomainApiService) DomainSsrfCheck(ctx context.Context, request UrlSsrfRequestFull) (UrlSsrfResponseFull, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue UrlSsrfResponseFull
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/validate/domain/url/ssrf-threat-check"
...
/* 
DomainApiService Check a URL for SSRF threats in batches
...
*/
func (a *DomainApiService) DomainSsrfCheckBatch(ctx context.Context, request UrlSsrfRequestBatch) (UrlSsrfResponseBatch, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue UrlSsrfResponseBatch
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/validate/domain/url/ssrf-threat-check/batch"
...
/* 
DomainApiService Check a URL for HTML embedded SSRF threats
...
*/
func (a *DomainApiService) DomainUrlHtmlSsrfCheck(ctx context.Context, request UrlHtmlSsrfRequestFull) (UrlHtmlSsrfResponseFull, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue UrlHtmlSsrfResponseFull
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/validate/domain/url/ssrf-threat-check/html-embedded"
